...
TEST_F(TestCalcFromDisk, Test_NFRC_102_optics)
{
    ...
    double u_result = calc_u(standard, products, gaps, 1.0, 1.0, nfrc_u_environments());
    ...
    double shgc_result = calc_shgc(standard, products, gaps, 1.0, 1.0, nfrc_shgc_environments());
...
TEST_F(TestCalcFromDisk, Test_NFRC_102_102_optics)
{
    ...
    Thermal_Result u_result = calc_u(standard, products, gaps, 1.0, 1.0, nfrc_u_environments());
    ...
    Thermal_Result shgc_result = calc_shgc(standard, products, gaps, 1.0, 1.0, nfrc_shgc_environments());
