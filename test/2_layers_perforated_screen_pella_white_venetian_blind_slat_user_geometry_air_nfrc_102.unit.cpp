...
class Test_2_layers_perforated_screen_pella_white_venetian_blind_slat_user_geometry_air_nfrc_102 : public testing::Test
{
protected:
...
TEST_F(Test_2_layers_perforated_screen_pella_white_venetian_blind_slat_user_geometry_air_nfrc_102, Test_Thermal)
{
    test_thermal_results(
      "2_layers/perforated_screen_pella_white_venetian_blind_slat_user_geometry_air_nfrc_102/quarter_basis", "thermal_U_Environment", glazing_system_u, update_results);
    test_thermal_results(
      "2_layers/perforated_screen_pella_white_venetian_blind_slat_user_geometry_air_nfrc_102/quarter_basis", "thermal_SHGC_Environment", glazing_system_shgc, update_results);
}

TEST_F(Test_2_layers_perforated_screen_pella_white_venetian_blind_slat_user_geometry_air_nfrc_102, Test_Optical)
{
    test_optical_results("2_layers/perforated_screen_pella_white_venetian_blind_slat_user_geometry_air_nfrc_102/quarter_basis", glazing_system_u, update_results);
}
