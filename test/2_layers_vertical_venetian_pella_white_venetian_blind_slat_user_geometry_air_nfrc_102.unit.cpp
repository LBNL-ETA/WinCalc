...
class Test_2_layers_vertical_venetian_pella_white_venetian_blind_slat_user_geometry_air_nfrc_102 : public testing::Test
{
protected:
    ...
    virtual void SetUp()
    {
        ...
        venetian_material_path /= "pella_white_venetian_blind_slat.json";
		...
		wincalc::Venetian_Geometry geometry{45, 0.03, 0.08, 0.03, false};
...
TEST_F(Test_2_layers_vertical_venetian_pella_white_venetian_blind_slat_user_geometry_air_nfrc_102, Test_Thermal)
{
    test_thermal_results(
      "2_layers/vertical_venetian_pella_white_venetian_blind_slat_user_geometry_air_nfrc_102/quarter_basis", "thermal_U_Environment", glazing_system_u, update_results);
    test_thermal_results(
      "2_layers/vertical_venetian_pella_white_venetian_blind_slat_user_geometry_air_nfrc_102/quarter_basis", "thermal_SHGC_Environment", glazing_system_shgc, update_results);
}

TEST_F(Test_2_layers_vertical_venetian_pella_white_venetian_blind_slat_user_geometry_air_nfrc_102, Test_Optical)
{
    test_optical_results("2_layers/vertical_venetian_pella_white_venetian_blind_slat_user_geometry_air_nfrc_102/quarter_basis", glazing_system_u, update_results);
}
