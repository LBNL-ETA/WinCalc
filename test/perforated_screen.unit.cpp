...
class TestPerforatedScreen : public testing::Test
{
protected:
...
TEST_F(TestPerforatedScreen, Test_Thermal)
{
    test_thermal_results("perforated_screen", "thermal_U_Environment", glazing_system_u, update_results);
    test_thermal_results(
      "perforated_screen", "thermal_SHGC_Environment", glazing_system_shgc, update_results);
}

TEST_F(TestPerforatedScreen, Test_Optical)
{
    test_optical_results("perforated_screen", glazing_system_u, update_results);
}
