...
class TestUserVerticalVenetianNFRC102 : public testing::Test
{
protected:
...
TEST_F(TestUserVerticalVenetianNFRC102, Test_Thermal)
{
    test_thermal_results(
      "User_Vertical_Venetian_NFRC_102", "thermal_U_Environment", glazing_system_u, update_results);
    test_thermal_results(
      "User_Vertical_Venetian_NFRC_102", "thermal_SHGC_Environment", glazing_system_shgc, update_results);
}

TEST_F(TestUserVerticalVenetianNFRC102, Test_Optical)
{
    test_optical_results("User_Vertical_Venetian_NFRC_102", glazing_system_u, update_results);
}
