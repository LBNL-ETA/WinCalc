...
class Test_2_layers_vertical_venetian_cgdb_3000_air_nfrc_102_uniform_diffuse : public testing::Test
{
protected:
    ...
    virtual void SetUp()
    {
        ...
        auto optical_venetian = std::dynamic_pointer_cast<wincalc::Product_Data_Optical_Venetian>(
...
TEST_F(Test_2_layers_vertical_venetian_cgdb_3000_air_nfrc_102_uniform_diffuse,
       Test_Thermal)
{
    test_thermal_results(
      "2_layers/vertical_venetian_cgdb_3000_air_nfrc_102/uniform_diffuse/quarter_basis", "thermal_U_Environment", glazing_system_u, update_results);
    test_thermal_results("2_layers/vertical_venetian_cgdb_3000_air_nfrc_102/uniform_diffuse/quarter_basis",
...
TEST_F(Test_2_layers_vertical_venetian_cgdb_3000_air_nfrc_102_uniform_diffuse,
       Test_Optical)
{
    test_optical_results("2_layers/vertical_venetian_cgdb_3000_air_nfrc_102/uniform_diffuse/quarter_basis", glazing_system_u, update_results);
}
