...
class Test_2_layers_nfrc_102_air_bsdf_xml_thermal_openness_10_mm_top_and_bottom : public testing::Test
{
protected:
...
TEST_F(Test_2_layers_nfrc_102_air_bsdf_xml_thermal_openness_10_mm_top_and_bottom, Test_Thermal)
{
    test_thermal_results("2_layers/nfrc_102_air_bsdf_xml/thermal_openness_0.01_top_and_bottom/full_basis",
...
TEST_F(Test_2_layers_nfrc_102_air_bsdf_xml_thermal_openness_10_mm_top_and_bottom, Test_Optical)
{
    test_optical_results(
      "2_layers/nfrc_102_air_bsdf_xml/thermal_openness_0.01_top_and_bottom/full_basis", glazing_system_u, update_results);
}
