...
{
    test_thermal_results("1_layer/coated_nfrc_6400/no_basis", "thermal_U_Environment", glazing_system_u, update_results);
    test_thermal_results(
      "1_layer/coated_nfrc_6400/no_basis", "thermal_SHGC_Environment", glazing_system_shgc, update_results);
}


TEST_F(Test_1_layer_coated_nfrc_6400, Test_Optical)
{
    test_optical_results("1_layer/coated_nfrc_6400/no_basis", glazing_system_u, update_results);
}
