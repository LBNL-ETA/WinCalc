...
// This ID no longer exists in igsdb.lbl.gov and the version of the json saved in the repo
// no longer matches the json returned by igsdb.lbl.gov and so can no longer be parsed.
// Reinstate test if someone figures out if the NFRC ID changed.

#if 0
using namespace wincalc;
using namespace window_standards;

class TestNFRC9023: public testing::Test
{
protected:
...
TEST_F(TestNFRC9023, Test_Solar)
{
...
TEST_F(TestNFRC9023, Test_Color)
{
