...
class TestNFRC102NFRC102ForcedVentilation : public testing::Test
{
protected:
...
TEST_F(TestNFRC102NFRC102ForcedVentilation, Test_Optical)
{
    test_optical_results("NFRC_102_NFRC_102_forced_ventilation", glazing_system_u, update_results);
}
