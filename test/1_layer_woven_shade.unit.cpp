...
TEST_F(Test_1_layer_woven_shade, Test_Thermal)
{
    ...
    test_thermal_results(
      "1_layer/woven_shade/quarter_basis", "thermal_U_Environment", glazing_system_u_quarter, update_results);
    test_thermal_results("1_layer/woven_shade/quarter_basis",
...
TEST_F(Test_1_layer_woven_shade, Test_Optical)
{
    ...
    test_optical_results("1_layer/woven_shade/quarter_basis", glazing_system_u_quarter, update_results);
}
