...
TEST_F(TestIGSDB_14025, Test_IR)
{
    ...
    EXPECT_NEAR(ir_results.hemispheric_emissivity_front, 0.84337714961619636, 1e-6);
    EXPECT_NEAR(ir_results.hemispheric_emissivity_back, 0.037321857598487045, 1e-6);
}
