...
TEST_F(TestNFRC102, Test_Visible)
{
...
TEST_F(TestNFRC102, Test_SPF)
{
    EXPECT_THROW(
      glazing_system_u->optical_method_results(Optical_Standard_Method_Type::SPF), std::runtime_error);
}

TEST_F(TestNFRC102, Test_TDW)
{
