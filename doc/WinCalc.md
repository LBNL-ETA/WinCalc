...
graph TD
    ...
    WindowsCalcEngine[WindowsCalcEngine<br/><font color='red'>Version_1.0.57</font>]
    Windows-CalcStandards[Windows-CalcStandards<br/><font color='red'>v1.2.2</font>]
    LibraryFEMTHERM[LibraryFEMTHERM<br/><font color='red'>Verion_0.11</font>]
    WinCalc[WinCalc<br/><font color='red'>v2.5.8</font>]
