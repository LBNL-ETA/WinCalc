...
graph TD
    ...
    WindowsCalcEngine[WindowsCalcEngine<br/><font color='red'>WavelengthMatrices</font>]
    Windows-CalcStandards[Windows-CalcStandards<br/><font color='red'>v1.2.2</font>]
    LibraryFEMTHERM[LibraryFEMTHERM<br/><font color='red'>TemporaryRecords</font>]
    WinCalc[WinCalc<br/><font color='red'>WavelengthMatrices</font>]
