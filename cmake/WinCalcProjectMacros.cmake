...
macro(ADD_GOOGLE_TESTS_WINCALC executable)
  foreach ( source ${ARGN} )
...
macro( CREATE_SRC_GROUPS_WINCALC SRC )
  foreach( F ${SRC} )
...
# Create test targets
macro( CREATE_TEST_TARGETS_WINCALC BASE_NAME SRC DEPENDENCIES )
  if( BUILD_WINCALC_TESTING )
    ...
    ADD_GOOGLE_TESTS_WINCALC( ${BASE_NAME}_tests ${SRC} )
  endif()
endmacro()
